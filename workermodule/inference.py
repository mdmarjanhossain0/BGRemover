...
class BGRemove():
    ...
    def __init__(self, ckpt_path = 'workermodule/pretrained/modnet_photographic_portrait_matting.ckpt'):
    ...
    def post_process(self, mask_data, background=False, backgound_path='workermodule/assets/background/background.jpg'):
    ...
    def image(self, filename, background=False, output='workermodule/output/', save=True):
